...
const WriteArticle = () => {
 ...
 const articlelength = [
  {length :800, text: 'short (600-800 words)'},
 ...
 const onSubmitHandler = async (e)=>{
  ...
  try {
    setLoading(true)
    const prompt = `Write a detailed article about ${input} in ${selectedLength.text}. Make sure the article is comprehensive and well-structured.`
